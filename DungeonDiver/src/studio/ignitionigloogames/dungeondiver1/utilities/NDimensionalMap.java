...
public interface NDimensionalMap extends Serializable {
    ...
    MapObject getCellOffset(final NDimensionalLocation loc, final NDimensionalLocation offset, MapObject defaultValue);
    ...
    boolean findNthObjectOnDimension(final int dimension, final int N, final MapObject obj);
    ...
    void fillMapRandomly(final MapObjectList objects, final MapObject pass1Fill);

    void fillMapDimensionRandomly(final MapObjectList objects, final MapObject pass1Fill, final int dimension);
    ...
    Container drawOtherWithVisibility(int appearanceID, NDimensionalLocation otherDimensions);
