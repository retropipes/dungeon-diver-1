...
public abstract class MapObject implements RandomGenerationRule {
    ...
    // Fields
    private final BufferedImageIcon[] appearances;
    ...
    // Constructors
    protected MapObject(final int otherAppearanceCount, final boolean isSolid, final String newName,
	    final MapObject prereqObject) {
	...
	this.appearances = new BufferedImageIcon[MapObject.OTHER_APPEARANCES_OFFSET + fixedOtherAppearanceCount];
	this.solid = isSolid;
	this.name = newName;
    ...
    public BufferedImageIcon getEditorAppearance() {
	return this.appearances[MapObject.EDITOR_APPEARANCE];
    }

    public final BufferedImageIcon getOtherAppearance(final int ID) {
	return this.appearances[MapObject.OTHER_APPEARANCES_OFFSET + ID];
    }

    public final void setGameAppearance(final BufferedImageIcon newAppearance) {
	this.appearances[MapObject.GAME_APPEARANCE] = newAppearance;
    }

    public final void setEditorAppearance(final BufferedImageIcon newAppearance) {
	this.appearances[MapObject.EDITOR_APPEARANCE] = newAppearance;
    }

    public final void setOtherAppearance(final int ID, final BufferedImageIcon newAppearance) {
