...
public class NeverGeneratedMapObject extends MapObject {
    ...
    // Constructors
    public NeverGeneratedMapObject(final int otherAppearanceCount, final boolean isSolid, final String newName) {
	super(otherAppearanceCount, isSolid, newName, null);
    }

    // Methods
    @Override
    public final boolean shouldGenerateObject(final NDimensionalLocation loc, final NDimensionalMap map) {
	return false;
    }
