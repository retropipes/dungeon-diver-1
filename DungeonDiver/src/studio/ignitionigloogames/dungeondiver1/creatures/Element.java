...
public class Element {
    ...
    // Constructor
    public Element(final double red, final double green, final double blue, final boolean darkEye,
	...
	if (source.equals(Element.makeTrans)) {
	    ...
	    transformed = new Color(transformedRed, transformedGreen, transformedBlue);
	}
	return transformed;
    }
}
