...
public class ElementList {
	...
	for (int r = 0; r < 5; r++) {
		...
		for (int b = 0; b < 5; b++) {
			...
			ElementList.elementNames[counter] = ElementList.getElementNameByPosition(counter);
			final boolean eye = ElementList.getElementEyeByPosition(counter);
			final double r2 = r / 4.0;
			final double g2 = g / 4.0;
			final double b2 = b / 4.0;
			ElementList.list[counter] = new Element(r2, g2, b2, eye, ElementList.elementNames[counter]);
			counter++;
		    }
		}
	    }
