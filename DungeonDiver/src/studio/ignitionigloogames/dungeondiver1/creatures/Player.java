...
public abstract class Player extends Creature {
    ...
    public Player(final int pAtk, final int pDef, final int pHP, final int pMP, final int k) {
	super();
	this.level = 1;
	...
	return this.power + this.weapon + this.permanentAttack + this.classBonusAttack;
    }
	...
	return this.block + this.armor + this.permanentDefense + this.classBonusDefense;
    }
    ...
    public void loadPlayer(final int pAttack, final int pDefense, final int pHP, final int pMP, final int newKills,
	    final int newLevel, final int chp, final int cmp, final int newWeapon, final int newArmor,
	    final int newGold, final int newBank, final long newExperience, final int dl, final int bookID) {
	...
	this.maximumHP = this.level * this.hpPerLevel + this.permanentHP * this.permanentHPperPoint;
	this.maximumMP = this.level * this.mpPerLevel + this.permanentMP * this.permanentMPperPoint;
    }
