...
public class GraphicsManager {
	...
	try {
	    return new BufferedImageIcon(ImageIO.read(GraphicsManager.class.getResource("/asset/image/boss/boss.png")));
	...
	final BufferedImageIcon template = GraphicsManager.getMonsterTemplate(name);
	final BufferedImageIcon templateOut = GraphicsManager.getMonsterTemplate(name);
	...
	try {
	    ...
	    return new BufferedImageIcon(
		    ImageIO.read(GraphicsManager.class.getResource("/asset/image/monster/" + normalName + ".png")));
	} catch (final IOException ie) {
	    DungeonDiver.debug(ie);
	    return null;
	}
