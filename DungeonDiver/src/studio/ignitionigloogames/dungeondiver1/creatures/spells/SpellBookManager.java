...
public class SpellBookManager {
	...
	if (s != null) {
		...
		JOptionPane.showMessageDialog(null, "You try to cast a spell, but realize you don't have enough MP!",
	...
	if (book != null) {
	    ...
	    dialogResult = (String) JOptionPane.showInputDialog(null, "Select a Spell to Cast", "Select Spell",
	    ...
	    JOptionPane.showMessageDialog(null, "You try to cast a spell, but realize you don't know any!",
		    "Select Spell", JOptionPane.WARNING_MESSAGE);
	    return null;
	}
    }
	...
	String dialogResult = null;
	dialogResult = (String) JOptionPane.showInputDialog(null, "Select a Class", "Select Class",
