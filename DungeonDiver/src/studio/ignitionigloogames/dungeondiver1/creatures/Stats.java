...
public class Stats {
	...
	statString[3] = "Weapon: "
		+ ItemNames.getItemName(ShopTypes.WEAPONS, player.getWeaponPower(), player.getPlayerClass());
	statString[4] = "Armor: "
		+ ItemNames.getItemName(ShopTypes.ARMOR, player.getArmorBlock(), player.getPlayerClass());
