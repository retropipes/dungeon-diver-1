...
public class Monster extends GenericNSRSBObject {
	...
	final NDimensionalLocation playerLoc = DungeonDiver.getHoldingBag().getDungeonGUI().getPlayerLocation();
	DungeonDiver.getHoldingBag().getDungeonGUI().postBattle(playerLoc, this, true);
    }
	...
	DungeonDiver.getHoldingBag().getDungeonGUI().updateMonsterPosition(xMove, yMove, xLoc, yLoc, this);
    }
