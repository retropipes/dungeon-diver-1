...
public class MenuManager implements ShopTypes {
	...
	this.gameEndGameAccel = KeyStroke.getKeyStroke(KeyEvent.VK_E, modKey + InputEvent.SHIFT_DOWN_MASK);
	this.gameExploreDungeonAccel = KeyStroke.getKeyStroke(KeyEvent.VK_E, modKey);
	this.gameNewDungeonAccel = KeyStroke.getKeyStroke(KeyEvent.VK_N, modKey + InputEvent.SHIFT_DOWN_MASK);
	this.gamePreferencesAccel = KeyStroke.getKeyStroke(KeyEvent.VK_COMMA, modKey);
    }
