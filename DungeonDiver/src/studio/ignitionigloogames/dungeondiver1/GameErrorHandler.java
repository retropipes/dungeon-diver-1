...
final class GameErrorHandler implements ErrorHandler {
	...
	JOptionPane.showMessageDialog(null, GameErrorHandler.ERROR_MESSAGE, GameErrorHandler.ERROR_TITLE,
	...
	JOptionPane.showMessageDialog(null, GameErrorHandler.WARNING_MESSAGE, GameErrorHandler.WARNING_TITLE,
	...
	JOptionPane.showMessageDialog(null, msg, GameErrorHandler.ERROR_TITLE, JOptionPane.ERROR_MESSAGE);
	this.logger.logError(t);
    }

    private void logWarningWithMessage(final Throwable t, final String msg) {
	JOptionPane.showMessageDialog(null, msg, GameErrorHandler.WARNING_TITLE, JOptionPane.WARNING_MESSAGE);
	this.logger.logWarning(t);
    }
}
