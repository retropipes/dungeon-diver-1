...
public class Preferences {
	...
	this.setPreferenceValue(Preferences.CLOCKWISE_ROTATION_TRAP_ENABLED, true);
	this.setPreferenceValue(Preferences.COUNTERCLOCKWISE_ROTATION_TRAP_ENABLED, true);
	...
	this.prefs[Preferences.MOVEMENT_MODIFIERS_DISABLED] = new JCheckBox("Disable ALL movement modifiers", false);
	this.prefs[Preferences.CONFUSION_TRAP_ENABLED] = new JCheckBox("Enable confusion traps", true);
	this.prefs[Preferences.CLOCKWISE_ROTATION_TRAP_ENABLED] = new JCheckBox("Enable clockwise rotation traps",
		true);
	this.prefs[Preferences.COUNTERCLOCKWISE_ROTATION_TRAP_ENABLED] = new JCheckBox(
		"Enable counterclockwise rotation traps", true);
	this.prefs[Preferences.SPINNER_TRAP_ENABLED] = new JCheckBox("Enable spinner traps", true);
	this.prefs[Preferences.WARP_TRAP_ENABLED] = new JCheckBox("Enable warp traps", true);
	this.prefs[Preferences.ICE_ENABLED] = new JCheckBox("Enable ice", true);
	this.prefs[Preferences.MONSTERS_ON_MAP_ENABLED] = new JCheckBox("Show monsters in dungeon", true);
	...
	this.prefs[Preferences.MOVEMENT_MODIFIERS_DISABLED].addItemListener(this.handler);
