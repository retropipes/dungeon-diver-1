...
import studio.ignitionigloogames.dungeondiver1.creatures.PlayerClasses;
...
public class ItemNames implements ShopTypes {
    ...
    // Methods
    public static String getItemName(final int type, final int level, final int playerClass) {
	return ItemNames.getItemMaterial(level) + " " + ItemNames.getItemType(type, playerClass);
    }
